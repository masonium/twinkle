...
//! Class for automatic conversion from string -> anytype
  ...
  public:
    ...
    bool operator == (const char* s) { return s == str; }
    ...
    operator short() { return as<short>(); }
    operator unsigned short() { return as<unsigned short>(); }
    operator int() { return as<int>(); }
    operator unsigned int() { return as<unsigned int>(); }
    operator long() { return as<long>(); }
    operator unsigned long() { return as<unsigned long>(); }
    operator float() { return as<float>(); }
    operator double() { return as<double>(); }
    operator long double() { return as<long double>(); }
  private:
